...
function HTML_vid_player_1( FN, TF, LOname)
  {
  var fldn = LOname
  var mURL = '../../media/' +  fldn   + '/video/mp4/' + FN
  eval(w_tool())
  if(TF)
...
function HTML_vid_player_2( FN, TF, LOname)
  {
  var sFN  = removeFileExt(FN)
  var fldn = LOname
  ////var mURL = '../../media/' +  fldn   + '/video/' + FN
  eval(w_tool())
  if(TF)
    wl('<video width="270"  height="208" controls="controls" autoplay="autoplay">')
  else
    wl('<video width="270"  height="208" controls="controls">')

  var vidType = document.createElement('video')
  if(vidType.canPlayType('video/mp4') == "true" || vidType.canPlayType('video/mp4') == "maybe" )
    {
     var mURL = '../../media/' +  fldn   + '/video/' + sFN + '.mp4'
     wl('<source src="' + mURL +'" type="video/mp4">')
    }
  if(vidType.canPlayType('video/ogg') == "true" || vidType.canPlayType('video/ogg') == "maybe" )
    {
     var mURL = '../../media/' +  fldn   + '/video/' + sFN + '.ogg'
     wl('<source src="' + mURL +'" type="video/ogg">')
    }
  wl('</video>')
  return wr
...
function HTML_vid_player_3( FN, TF, LOname)
  {
  var sFN  = removeFileExt(FN)
  var fldn = LOname
  ////var mURL = '../../media/' +  fldn   + '/video/' + FN
  eval(w_tool())
  if(TF)
    wl('<video width="270"  height="202" controls="controls" autoplay="autoplay">')
  else
    wl('<video width="270"  height="202" controls="controls">')
