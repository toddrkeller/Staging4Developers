if (gv_server)
  {
  var vid_js = window.gateway.paths.xml + 'ja_l33_07/'+ 'videoPlay.js'
...
var g_crrtIndex = []
var g_questCat = ['Semantic','Semantic']
var Try = -1
...
//********************** homework check (2/4) *************//
var hw = false
var txtques         =   [ 'Who is Barack Obama?','Who is investigating the theft?' ]
var crrtAnsValue    =   ['President of United States','Human rights activist','Senator','Soldier','CIA','FBI','DLI','NSA']            //// the list of corret Answer Values  (such as ['a', 'aa', 'aaa', 'b', 'bb', 'bbb', 'bbbb']    //// 'aaa', and 'bbbb' are the answer in this case

var respItemNo      =   [0,0,0,0,1,1,1,1]
var crrtAnsWhole    =   [0,5]             //// the list of all correct answers from all dbf_responses without considering (each) page number (such as [2, 6])
...
function vidPopUp(fn)
  ...
  function non_ie( fn, dh, dw)
    ...
    var loname = 'ja_l01_1372184624255/'
    d.open()
    getPlayer(fn, loname)
    d.close()
  ...
  if (navigator.appName == "Microsoft Internet Explorer")
    PopUp4('', 'Video Clip', fn, '', '', 'ja_l01_1372184624255/')
  else
    non_ie(fn)
  }
...
function gen_ques()
  ...
  xid('id_Qb'+curr_item).style.display = ''
  }
...
function grad_it(indexNo)
  ...
  if (indexNo == g_crrtIndex[curr_item])
     ...
     var fbH = 0
     if(xid('id_feedback').offsetHeight < 280)
        {
        fbH =  280 - xid('id_feedback').offsetHeight
     ...
     ////vidPopUp_test(fb_flv)   //audD
      loadVideo('../../media/ja_l01_1372184624255/', removeFileExt (fb_flv), '', false, true)
...
function install_handlers()
  ...
  xid('id_checkBtn').onclick = function()
   ...
   //*********************  end of homework check (3/4) *************************//
    ...
    var rv = classify(xid('id_Q'+curr_item), 'span', 'activity_p_lrg_2')      /// checked raido value   homework
    var checkedIndex = -1
